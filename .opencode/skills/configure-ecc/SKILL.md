...
```bash
# Common rules (flat copy into .opencode/plugins/cache/everything-claude-code/rules/)
cp -r $ECC_ROOT/.opencode/plugins/cache/everything-claude-code/rules/common/* $TARGET/.opencode/plugins/cache/everything-claude-code/rules/

# Language-specific rules (flat copy into .opencode/plugins/cache/everything-claude-code/rules/)
cp -r $ECC_ROOT/.opencode/plugins/cache/everything-claude-code/rules/typescript/* $TARGET/.opencode/plugins/cache/everything-claude-code/rules/   # if selected
cp -r $ECC_ROOT/.opencode/plugins/cache/everything-claude-code/rules/python/* $TARGET/.opencode/plugins/cache/everything-claude-code/rules/        # if selected
cp -r $ECC_ROOT/.opencode/plugins/cache/everything-claude-code/rules/golang/* $TARGET/.opencode/plugins/cache/everything-claude-code/rules/        # if selected
```
...
```bash
ls -la $TARGET/skills/
ls -la $TARGET/.opencode/plugins/cache/everything-claude-code/rules/
```
...
```bash
grep -rn "~/.claude/" $TARGET/skills/ $TARGET/.opencode/plugins/cache/everything-claude-code/rules/
grep -rn "../common/" $TARGET/.opencode/plugins/cache/everything-claude-code/rules/
...
- If a skill references `~/.claude/skills/` or `~/.claude/.opencode/plugins/cache/everything-claude-code/rules/` — this may be broken if installed only at project level
...
### "Rules not working"
- Rules are flat files, not in subdirectories: `$TARGET/.opencode/plugins/cache/everything-claude-code/rules/coding-style.md` (correct) vs `$TARGET/.opencode/plugins/cache/everything-claude-code/rules/common/coding-style.md` (incorrect for flat install)
