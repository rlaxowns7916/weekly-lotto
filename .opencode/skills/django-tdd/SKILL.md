...
```python
# .opencode/plugins/cache/everything-claude-code/tests/conftest.py
import pytest
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/factories.py
import factory
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/test_models.py
import pytest
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/test_views.py
import pytest
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/test_serializers.py
import pytest
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/test_api.py
import pytest
from rest_framework.test import APIClient
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/test_email.py
...
```python
# .opencode/plugins/cache/everything-claude-code/tests/test_integration.py
import pytest
from django.urls import reverse
from tests.factories import UserFactory, ProductFactory
