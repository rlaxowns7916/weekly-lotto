...
- **Test layout**: `.opencode/plugins/cache/everything-claude-code/tests/unit`, `.opencode/plugins/cache/everything-claude-code/tests/integration`, `.opencode/plugins/cache/everything-claude-code/tests/testdata`.
...
```cpp
// .opencode/plugins/cache/everything-claude-code/tests/add_test.cpp
...
```cpp
// .opencode/plugins/cache/everything-claude-code/tests/calculator_test.cpp
#include <gtest/gtest.h>
...
```cpp
// .opencode/plugins/cache/everything-claude-code/tests/user_store_test.cpp
...
```cpp
// .opencode/plugins/cache/everything-claude-code/tests/notifier_test.cpp
