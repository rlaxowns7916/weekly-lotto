...
2. Extract all .opencode/plugins/cache/everything-claude-code/scripts/commands with their descriptions
...
Generate or update `.opencode/plugins/cache/everything-claude-code/docs/CONTRIBUTING.md` with:
...
Generate or update `.opencode/plugins/cache/everything-claude-code/docs/RUNBOOK.md` with:
...
──────────────────────────────
Updated:  .opencode/plugins/cache/everything-claude-code/docs/CONTRIBUTING.md (scripts table)
Updated:  .opencode/plugins/cache/everything-claude-code/docs/ENV.md (3 new variables)
Flagged:  .opencode/plugins/cache/everything-claude-code/docs/DEPLOY.md (142 days stale)
Skipped:  .opencode/plugins/cache/everything-claude-code/docs/API.md (no changes detected)
──────────────────────────────
```
