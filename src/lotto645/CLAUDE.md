...
## 의존성 계약
- 내부 경계: `src/lotto645/browser`, `src/lotto645/browser/actions`, `src/lotto645/commands`, `src/lotto645/domain`, `src/lotto645/services`, `src/shared/browser`, `src/shared/browser/actions`, `src/shared/config`, `src/shared/services`, `src/shared/utils`.
