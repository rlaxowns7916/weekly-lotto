...
- SCN-002: Given 로그인/구매/당첨조회 실패, When 커맨드가 예외를 감지, Then `processExitCode=1` and `output contains "실패"`.
...
## 의존성 계약
- 내부 경계: `src/pension720/browser/actions`, `src/pension720/services`, `src/shared/browser`, `src/shared/browser/actions`, `src/shared/services`, `src/shared/utils`.
